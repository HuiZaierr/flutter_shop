...
class CollectListBean {
  ...
  CollectListBean({this.code, this.msg, this.type, this.data});

  CollectListBean.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    msg = json['msg'];
    type = json['type'];
...
class Data {
  ...
  Data({this.ps, this.totalpage, this.pno, this.collectList});
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    pno = json['pno'];
    if (json['list'] != null) {
      collectList = new List<CollectList>();
      json['list'].forEach((v) {
        collectList.add(new CollectList.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.collectList != null) {
      data['list'] = this.collectList.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
