...
class CollectPageHaveDataListArea extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Provide<CollectListProvide>(builder: (context,child,value){
      return Container(
        ...
        child: Wrap(
          spacing: 3,
          children: ItemViewList(value.collectList),
        ),
      );
    });
  }
...
Title(String title){
   return Container(
     ...
     child: Text(
       ...
       style: TextStyle(fontSize: ScreenUtil().setSp(39), color: Colors.black87,fontWeight: FontWeight.w700)),
   );
}
...
BottomInfo(List<CollectList> list,int index){
  return Container(
    width: ScreenUtil().setWidth(310),
    margin: EdgeInsets.fromLTRB(1,0,3,17),
    child: Row(
      children: <Widget>[
...
UpdateImage(){
  return Container(
    child: Image.asset(R.assetsImgIconContentsNew,width: ScreenUtil().setWidth(90),height: ScreenUtil().setHeight(21),),
  );
}
